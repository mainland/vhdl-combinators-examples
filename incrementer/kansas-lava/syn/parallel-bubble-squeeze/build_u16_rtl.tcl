set outputDir ./outputs_u16_rtl
file mkdir $outputDir

read_vhdl -vhdl2008 ../../vhdl/Lava.vhd
read_vhdl -vhdl2008 ../../vhdl/parallel-bubble-squeeze/incrementer_rtl_dsl.vhd
set_property top incrementer [current_fileset]
set_property top_file {../../vhdl/parallel-bubble-squeeze/incrementer_rtl_dsl.vhd} [current_fileset]
read_xdc ./const/const_rtl_dsl.xdc
