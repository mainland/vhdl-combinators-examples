set outputDir ./outputs_uq16
file mkdir $outputDir

read_vhdl -vhdl2008 ../../vhdl/incrementer_uq16_parallel.vhd
set_property top incrementer [current_fileset]
set_property top_file {../../vhdl/incrementer_uq16_parallel.vhd} [current_fileset]
