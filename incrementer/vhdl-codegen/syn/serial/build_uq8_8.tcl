set outputDir ./outputs_uq8_8
file mkdir $outputDir

read_vhdl -vhdl2008 ../../vhdl/incrementer_uq8_8_serial.vhd
set_property top incrementer [current_fileset]
set_property top_file {../../vhdl/incrementer_uq8_8_serial.vhd} [current_fileset]
