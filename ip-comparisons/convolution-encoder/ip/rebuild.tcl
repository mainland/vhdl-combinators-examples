...
read_ip ip/convolution_0/convolution_0.xci
...
#synth_ip [get_ips ip/convolution_0]
...
#set_property generate_synth_checkpoint false [get_files ip/convolution_0/convolution_0.xci]

# Need to generate output products for IP
#generate_target all [get_files ip/convolution_0/convolution_0.xci]
