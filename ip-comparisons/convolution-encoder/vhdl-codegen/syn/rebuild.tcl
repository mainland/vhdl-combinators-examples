...
read_vhdl -vhdl2008 ../rtl/encoder.vhd
set_property top seq_5 [current_fileset]
set_property top_file {../rtl/encoder.vhd} [current_fileset]
read_xdc ./const/const.xdc

synth_design -top seq_5 -part xc7vx485tffg1761-2 -mode out_of_context -retiming
