...
#set_property generate_synth_checkpoint false [get_files ip/cordic_0/cordic_0.xci]

# Need to generate output products for IP
#generate_target all [get_files ip/cordic_0/cordic_0.xci]
