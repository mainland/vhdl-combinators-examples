...
read_vhdl -vhdl2008 ../rtl/divider_parallel.vhd
set_property top divider [current_fileset]
set_property top_file {../rtl/divider_parallel.vhd} [current_fileset]
read_xdc ./const/const_parallel.xdc

synth_design -top divider -part xc7vx485tffg1761-2 -mode out_of_context -retiming
